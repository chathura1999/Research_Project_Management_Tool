...
import { STUDENT_FEES_RESET, STUDENT_SEARCH_CLEAR } from "../constants/studentConstants";
...
const StudentFees = () => {
    ...
    const { loading: loadingfees, error: errorfees, success: successfees } = studentFees;
    ...
    return (
        <div className='container1'>
            <div className='search-form'>
                ...
                <form onSubmit={formSubmit}>
                    <input
                        ...
                        required
                    />
                    <select id='class' value={classname} onChange={(e) => setClassname(e.target.value)} required>
            ...
            {ok && successfees && <Message variant='success' message={successfees.message} />}
            {loading ? (
                <Loader />
            ) : error ? (
            ...
            <input type='text' />
                                ...
                                <div className='form-control'>
                                    ...
                                    <input type='string' value={new NepaliDate().format("YYYY")} />
                                </div>{" "}
                                <div className='form-control'>
