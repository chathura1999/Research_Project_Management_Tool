...
import TeacherUpdate from "./screens/TeacherUpdate";
import StudentUpdate from "./screens/StudentUpdate";
// import ExpenseScreen from './screens/ExpenseScreen'
        ...
        <Router>
            <div>
                <Switch>
                    ...
                    <PrivateRoute path='/submit-proposal' component={StaffRegister} />
                    <PrivateRoute path='/student-fee' component={StudentFees} />
                    <PrivateRoute path='/student_details' component={StudentDetails} exact />
                    <PrivateRoute path='/student_details/details/:id' component={StudentDeepDetails} exact />
                    {/* <PrivateRoute
            path='/student-attendance'
            component={underConstruction}
            exact
          /> */}
                    <PrivateRoute path='/teacher_attendance' component={underConstruction} exact />
                    <PrivateRoute path='/non-teaching_staff_attendance' component={underConstruction} exact />
                    <PrivateRoute path='/student-attendance/:class' component={StudentDeepAttendance} exact />
                    <PrivateRoute path='/students' component={Students} exact />
                    <PrivateRoute path='/teachers' component={Teachers} exact />
                    <PrivateRoute path='/admit_card/allstudents' component={AllStudentsAdmitCard} exact />
                    <PrivateRoute path='/admit_card' component={StudentAdmitCard} exact />
                    <PrivateRoute path='/admit_card/student' component={ParticularStudentAdmitCard} exact />
                    <PrivateRoute path='/teacher_register' component={TeacherRegister} exact />
                    <PrivateRoute path='/teacher_update' component={TeacherUpdate} exact />
                    <PrivateRoute path='/teacher_details' component={AllTeachers} exact />
                    <PrivateRoute path='/non-teaching_staff_details' component={AllStaffs} exact />
                    <PrivateRoute path='/non-teaching_staff_register' component={StaffRegister} exact />
                    <PrivateRoute path='/non-teaching_staff_salary' component={StaffSalary} exact />
                    <PrivateRoute path='/income' component={IncomeScreen} exact />
                    <PrivateRoute path='/salary' component={ExpenseScreen} exact />
                    <PrivateRoute path='/student-register' component={StudentRegister} exact />
                    <PrivateRoute path='/student_update' component={StudentUpdate} exact />
