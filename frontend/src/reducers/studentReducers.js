...
export const fetchStudentListReducer = (state = { studentList: [] }, action) => {
    switch (action.type) {
...
//STUDENT UPDATE REDUCER
export const studentUpdateReducer = (state = {}, action) => {
    switch (action.type) {
        //TODO: Change to STUDENT start
